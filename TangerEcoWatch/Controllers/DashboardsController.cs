    ...
    public class DashboardsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dashboard != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Dashboard'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("DashboardId,NumberOfReports,CleanupEvents,ActiveUsers")] Dashboard dashboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DashboardId,NumberOfReports,CleanupEvents,ActiveUsers")] Dashboard dashboard)
        {
        ...
        {
          return (_context.Dashboard?.Any(e => e.DashboardId == id)).GetValueOrDefault();
        }
    }
}
