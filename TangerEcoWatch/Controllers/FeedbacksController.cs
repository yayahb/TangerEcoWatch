...
namespace TangerEcoWatch.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FeedbackId,UserId,Text,SubmissionDate")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeedbackId,UserId,Text,SubmissionDate")] Feedback feedback)
        {
